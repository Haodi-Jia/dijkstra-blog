...
export function FeaturedPost({ post }: { post: Post }) {
  return (
    <Card className="ml-[58px] max-w-[1040px] gap-0 rounded-none bg-transparent py-[25px] pb-9 ring-0 max-[1100px]:ml-[38px] max-[760px]:ml-0 max-[760px]:py-14 max-[760px]:pb-[47px]">
      <CardContent className="px-0">
        <CardTitle className="text-[clamp(26px,1.8vw,30px)] leading-[1.42] font-bold tracking-[-0.025em] max-[760px]:text-[25px] max-[760px]:leading-[1.48] max-[760px]:tracking-[-0.02em]"><Link className="transition-colors hover:text-muted-foreground" href={`/posts/${post.slug}`}>{post.title}</Link></CardTitle>
