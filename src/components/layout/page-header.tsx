...
export function PageHeader({ articleIcon = true, large = false, title }: { articleIcon?: boolean; large?: boolean; title: string }) {
  return (
    <header className="flex min-h-[42px] items-center gap-[18px] max-[760px]:min-h-[29px] max-[760px]:gap-0">
